...
macro(gpAddPrivateIncludesPath INCLUDES)
  ...
  if ("${INCLUDES}" IN_LIST __GP_TARGET_PUB_DEPS)
  ...
  if ("${INCLUDES}" IN_LIST __GP_TARGET_INT_DEPS)
...
macro(gpAddPublicIncludesPath INCLUDES)
  ...
  list(APPEND __GP_TARGET_PUB_DEPS ${INCLUDES})
...
macro(gpAddInternalIncludesPath INCLUDES)
  ...
  list(APPEND __GP_TARGET_INT_DEPS ${INCLUDES})
