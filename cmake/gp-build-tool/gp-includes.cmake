...
macro(gpAddPrivateIncludesPath INCLUDES)
  ...
  if ("${INCLUDES}" IN_LIST __GP_TARGET_PUB_INCLUDES)
    gpFatal("includes path '${INCLUDES}' cannot be added as a private includes path because it is already listed as a public includes path.")
  endif()
  ...
  if ("${INCLUDES}" IN_LIST __GP_TARGET_INT_INCLUDES)
    gpFatal("includes path '${INCLUDES}' cannot be added as a private includes path because it is already listed as an internal includes path.")
  endif()
  ...
  if ("${INCLUDES}" IN_LIST __GP_TARGET_PRV_INCLUDES)
    gpFatal("includes path '${INCLUDES}' is already listed as a private includes path.")
  endif()
...
macro(gpAddPublicIncludesPath INCLUDES)
  ...
  if ("${INCLUDES}" IN_LIST __GP_TARGET_PRV_INCLUDES)
    gpFatal("includes path '${INCLUDES}' cannot be added as a public includes path because it is already listed as a private includes path.")
  endif()

  # Check that the includes path is not already in the internal includes paths to avoid conflicts
  if ("${INCLUDES}" IN_LIST __GP_TARGET_INT_INCLUDES)
    gpFatal("includes path '${INCLUDES}' cannot be added as a public includes path because it is already listed as an internal includes path.")
  endif()

  # Check that the includes path is not already in the public includes paths to avoid duplicates
  if ("${INCLUDES}" IN_LIST __GP_TARGET_PUB_INCLUDES)
    gpFatal("includes path '${INCLUDES}' is already listed as a public includes path.")
  endif()
...
macro(gpAddInternalIncludesPath INCLUDES)
  ...
  # Check that the includes path is not already in the public includes paths to avoid conflicts
  if ("${INCLUDES}" IN_LIST __GP_TARGET_PUB_INCLUDES)
    gpFatal("includes path '${INCLUDES}' cannot be added as a internal includes path because it is already listed as a public includes path.")
  endif()

  # Check that the includes path is not already in the private includes paths to avoid conflicts
  if ("${INCLUDES}" IN_LIST __GP_TARGET_PRV_INCLUDES)
    gpFatal("includes path '${INCLUDES}' cannot be added as a internal includes path because it is already listed as an private includes path.")
  endif()

  # Check that the includes path is not already in the internal includes paths to avoid duplicates
  if ("${INCLUDES}" IN_LIST __GP_TARGET_INT_INCLUDES)
    gpFatal("includes path '${INCLUDES}' is already listed as a internal includes path.")
  endif()
