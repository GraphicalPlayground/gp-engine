...
macro(__gpDefineCMakeTarget)
  ...
  get_property(_PUB_DEPS GLOBAL PROPERTY GP_TARGET_${__GP_TARGET_NAME}_PUB_DEPS)
  if (NUM_PUB_DEPS GREATER 0)
    set(_FINAL_PUB_DEPS)
    foreach(_dep IN LISTS __GP_TARGET_PUB_DEPS)
      if (_dep IN_LIST _PUB_DEPS AND NOT _dep MATCHES "^gp::")
  ...
  get_property(_PRV_DEPS GLOBAL PROPERTY GP_TARGET_${__GP_TARGET_NAME}_PRV_DEPS)
  if (NUM_PRV_DEPS GREATER 0)
    set(_FINAL_PRV_DEPS)
    foreach(_dep IN LISTS __GP_TARGET_PRV_DEPS)
      if (_dep IN_LIST _PRV_DEPS AND NOT _dep MATCHES "^gp::")
  ...
  get_property(_INT_DEPS GLOBAL PROPERTY GP_TARGET_${__GP_TARGET_NAME}_INT_DEPS)
  if (NUM_INT_DEPS GREATER 0)
    set(_FINAL_INT_DEPS)
    foreach(_dep IN LISTS __GP_TARGET_INT_DEPS)
      if (_dep IN_LIST _INT_DEPS AND NOT _dep MATCHES "^gp::")
