...
Doesn't need to be your best writing, just a few words and/or code snippets.
-->

## Checklist

- [ ] My code follows the `gp-engine` [C++ Coding Standard](https://docs.graphical-playground.com/docs/engine/programming-with-cpp/coding-standard).
...
- [ ] I have read and agree to the [Code of Conduct](../CODE_OF_CONDUCT.md) and [Contributing Guidelines](../CONTRIBUTING.md).
...
> _As far as the law allows, my contributions come as is, without any warranty or condition, and I
