...
using ResourceCollectRef = gp::RefCountPtr<ResourceCollection>;
using ShaderLibrRef = gp::RefCountPtr<ShaderLibrary>;
using ShaderResourceVRef = gp::RefCountPtr<ShaderResourceView>;
