...
/// @brief Unix-specific implementation of the memory management platform.
/// @note This class is not `final` to allow for platform-specific overrides in derived classes (e.g., Linux, macOS).
