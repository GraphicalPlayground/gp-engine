...
template <concepts::IsArithmetic T>
T min(const T a, const T b, const T c) noexcept
{
...
template <concepts::IsArithmetic T>
T max(const T a, const T b, const T c) noexcept
{
...
template <concepts::IsArithmetic T>
T clamp(const T value, const T minValue, const T maxValue) noexcept
{
...
template <concepts::IsArithmetic T>
requires concepts::IsSigned<T> T abs(const T value) noexcept
{
...
template <concepts::IsArithmetic T>
requires concepts::IsSigned<T> T sign(const T value) noexcept
{
...
bool isNearlyZero(const T value, const T tolerance = constants<T>::smallNumber) noexcept
{
...
template <concepts::IsFloatingPoint T>
bool isNearlyEqual(const T a, const T b, const T tolerance = constants<T>::smallNumber) noexcept
{
...
T lerp(const T a, const T b, const U t) noexcept
{
...
template <concepts::IsFloatingPoint T>
T inverseLerp(const T a, const T b, const T value) noexcept
{
...
template <concepts::IsFloatingPoint T>
T remap(const T inMin, const T inMax, const T outMin, const T outMax, const T value) noexcept
{
...
template <concepts::IsFloatingPoint T>
T smoothstep(const T edge0, const T edge1, const T x) noexcept
{
...
template <concepts::IsFloatingPoint T>
T degreesToRadians(const T degrees) noexcept
{
...
template <concepts::IsFloatingPoint T>
T radiansToDegrees(const T radians) noexcept
{
...
bool isPowerOfTwo(const T value) noexcept
{
...
template <concepts::IsIntegral T>
T nextPowerOfTwo(T value) noexcept
{
    if (value == 0)
    {
        return 1;
