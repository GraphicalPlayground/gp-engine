...
public:
    ...
    [[nodiscard]] static inline constexpr Vector3<T> zero()
    {
        return { T{ 0 }, T{ 0 }, T{ 0 } };
    }
    ...
    [[nodiscard]] static inline constexpr Vector3<T> one()
    {
        return { T{ 1 }, T{ 1 }, T{ 1 } };
    }
    ...
    [[nodiscard]] static inline constexpr Vector3<T> up()
    {
        return { T{ 0 }, T{ 1 }, T{ 0 } };
    }
    ...
    [[nodiscard]] static inline constexpr Vector3<T> down()
    {
        return { T{ 0 }, T{ -1 }, T{ 0 } };
    }
    ...
    [[nodiscard]] static inline constexpr Vector3<T> left()
    {
        return { T{ -1 }, T{ 0 }, T{ 0 } };
    }
    ...
    [[nodiscard]] static inline constexpr Vector3<T> right()
    {
        return { T{ 1 }, T{ 0 }, T{ 0 } };
    }
    ...
    [[nodiscard]] static inline constexpr Vector3<T> forward()
    {
        return { T{ 0 }, T{ 0 }, T{ 1 } };
    }
    ...
    [[nodiscard]] static inline constexpr Vector3<T> backward()
    {
        return { T{ 0 }, T{ 0 }, T{ -1 } };
    }
    ...
    [[nodiscard]] static inline constexpr Vector3<T> unitX()
    {
        return { T{ 1 }, T{ 0 }, T{ 0 } };
    }
    ...
    [[nodiscard]] static inline constexpr Vector3<T> unitY()
    {
        return { T{ 0 }, T{ 1 }, T{ 0 } };
    }
    ...
    [[nodiscard]] static inline constexpr Vector3<T> unitZ()
    {
        return { T{ 0 }, T{ 0 }, T{ 1 } };
    }
...
public:
    ...
    [[nodiscard]] constexpr Vector3() noexcept
        : x(T{ 0 })
        , y(T{ 0 })
        , z(T{ 0 })
    {}
    ...
    [[nodiscard]] constexpr Vector3(const T inX, const T inY, const T inZ) noexcept
        : x(inX)
        , y(inY)
        , z(inZ)
    {}
    ...
    [[nodiscard]] explicit constexpr Vector3(const T scalar) noexcept
        : x(scalar)
        , y(scalar)
        , z(scalar)
    {}
    ...
    [[nodiscard]] explicit constexpr Vector3(const T* const ptr) noexcept
        : x(ptr[0])
        , y(ptr[1])
        , z(ptr[2])
    {
    ...
    [[nodiscard]] explicit constexpr Vector3(const Vector3<U>& vec) noexcept
    ...
    [[nodiscard]] explicit constexpr Vector3(const Vector2<T>& vec, const U inZ = U{ 0 }) noexcept;
    ...
    [[nodiscard]] explicit constexpr Vector3(const Vector4<T>& vec) noexcept;
...
public:
    ...
    [[nodiscard]] constexpr Vector3<T> operator^(const Vector3<T>& other) const noexcept
    {
    ...
    [[nodiscard]] constexpr T operator|(const Vector3<T>& other) const noexcept
    {
    ...
    [[nodiscard]] constexpr Vector3<T> operator+(const U bias) const noexcept
    {
    ...
    template <concepts::IsArithmetic U>
    [[nodiscard]] constexpr Vector3<T> operator*(const U scale) const noexcept
    {
    ...
    /// false otherwise.
    [[nodiscard]] constexpr bool operator==(const Vector3<T>& other) const noexcept
    {
        return x == other.x && y == other.y && z == other.z;
    }
...
public:
    ...
    /// @param[in] other The other vector to compute the cross product with.
    /// @return The cross product of this vector and the other vector.
    [[nodiscard]] constexpr Vector3<T> cross(const Vector3<T>& other) const noexcept
    {
        return *this ^ other;
    }
    ...
    /// @param[in] other The other vector to compute the dot product with.
    /// @return The dot product of this vector and the other vector.
    [[nodiscard]] constexpr T dot(const Vector3<T>& other) const noexcept
    {
        return *this | other;
    }
    ...
    [[nodiscard]] constexpr Vector3<T> getComponentMin(const Vector3<T>& other) const noexcept
    {
    ...
    [[nodiscard]] constexpr Vector3<T> getComponentMax(const Vector3<T>& other) const noexcept
    {
    ...
    /// other vector.
    [[nodiscard]] constexpr Vector3<T> getComponentAbsMin(const Vector3<T>& other) const noexcept
    {
        return Vector3<T>(
    ...
    /// other vector.
    [[nodiscard]] constexpr Vector3<T> getComponentAbsMax(const Vector3<T>& other) const noexcept
    {
        return Vector3<T>(
    ...
    [[nodiscard]] constexpr Vector3<T> getAbsolute() const noexcept
    {
    ...
    [[nodiscard]] constexpr Vector3<T> getSignVector() const noexcept
    {
    ...
    [[nodiscard]] constexpr Vector3<T> getProjection() const noexcept
    {
        const T invZ = T{ 1 } / z;
    ...
    [[nodiscard]] constexpr Vector3<T> projectOnTo(const Vector3<T>& other) const noexcept
    {
    ...
    /// @return The projected vector.
    [[nodiscard]] constexpr Vector3<T> projectOnToNormal(const Vector3<T>& normal) const noexcept
    {
    ...
    [[nodiscard]] Vector3<T> mirrorByVector(const Vector3<T>& normal) const noexcept
    {
...
public:
    ...
    [[nodiscard]] constexpr static Vector3<T> cross(const Vector3<T>& lhs, const Vector3<T>& rhs) noexcept
    {
        return lhs ^ rhs;
    }
    ...
    [[nodiscard]] constexpr static T dot(const Vector3<T>& lhs, const Vector3<T>& rhs) noexcept
    {
        return lhs | rhs;
    }
    ...
    [[nodiscard]] constexpr static inline Vector3<T> min(const Vector3<T>& a, const Vector3<T>& b) noexcept
    {
    ...
    [[nodiscard]] constexpr static inline Vector3<T> max(const Vector3<T>& a, const Vector3<T>& b) noexcept
    {
    ...
    [[nodiscard]] constexpr static inline Vector3<T>
...
/// @return A vector containing the minimum of each component between the three vectors.
template <concepts::IsFloatingPoint T>
[[nodiscard]] constexpr Vector3<T> min(const Vector3<T>& a, const Vector3<T>& b, const Vector3<T>& c) noexcept
{
...
/// @return A vector containing the maximum of each component between the three vectors.
template <concepts::IsFloatingPoint T>
[[nodiscard]] constexpr Vector3<T> max(const Vector3<T>& a, const Vector3<T>& b, const Vector3<T>& c) noexcept
{
...
[[nodiscard]] constexpr gp::math::Vector3<T> operator+(const U bias, const gp::math::Vector3<T>& vec) noexcept
{
    return vec + bias;
}
...
template <gp::concepts::IsFloatingPoint T, gp::concepts::IsArithmetic U>
[[nodiscard]] constexpr gp::math::Vector3<T> operator*(const U scale, const gp::math::Vector3<T>& vec) noexcept
{
    return vec * scale;
}
