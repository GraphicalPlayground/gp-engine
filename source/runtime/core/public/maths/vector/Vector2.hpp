...
public:
    ...
    [[nodiscard]] static inline constexpr Vector2<T> zero()
    {
        return { T{ 0 }, T{ 0 } };
    }
    ...
    [[nodiscard]] static inline constexpr Vector2<T> one()
    {
        return { T{ 1 }, T{ 1 } };
    }
    ...
    [[nodiscard]] static inline constexpr Vector2<T> up()
    {
        return { T{ 0 }, T{ 1 } };
    }
    ...
    [[nodiscard]] static inline constexpr Vector2<T> down()
    {
        return { T{ 0 }, T{ -1 } };
    }
    ...
    [[nodiscard]] static inline constexpr Vector2<T> left()
    {
        return { T{ -1 }, T{ 0 } };
    }
    ...
    [[nodiscard]] static inline constexpr Vector2<T> right()
    {
        return { T{ 1 }, T{ 0 } };
    }
    ...
    [[nodiscard]] static inline constexpr Vector2<T> unitX()
    {
        return { T{ 1 }, T{ 0 } };
    }
    ...
    [[nodiscard]] static inline constexpr Vector2<T> unitY()
    {
        return { T{ 0 }, T{ 1 } };
    }
...
public:
    ...
    [[nodiscard]] constexpr Vector2(const T inX, const T inY) noexcept
        : x(inX)
        , y(inY)
    {}
    ...
    [[nodiscard]] explicit constexpr Vector2(const T scalar) noexcept
        : x(scalar)
        , y(scalar)
    {}
    ...
    [[nodiscard]] explicit constexpr Vector2(const T* const ptr) noexcept
        : x(ptr[0])
        , y(ptr[1])
    {
    ...
    [[nodiscard]] explicit constexpr Vector2(const Vector2<U>& vec) noexcept
    ...
    [[nodiscard]] explicit constexpr Vector2(const Vector3<T>& vec) noexcept;
    ...
    [[nodiscard]] explicit constexpr Vector2(const Vector4<T>& vec) noexcept;
...
public:
    ...
    [[nodiscard]] constexpr T operator^(const Vector2<T>& other) const noexcept
    {
    ...
    [[nodiscard]] constexpr Vector2<T> operator+(const Vector2<T>& other) const noexcept
    {
    ...
    [[nodiscard]] constexpr Vector2<T> operator+(const U bias) const noexcept
    {
    ...
    template <concepts::IsArithmetic U>
    [[nodiscard]] constexpr Vector2<T> operator*(const U scale) const noexcept
    {
    ...
    /// false otherwise.
    [[nodiscard]] constexpr bool operator==(const Vector2<T>& other) const noexcept
    {
        return x == other.x && y == other.y;
    }
...
public:
    ...
    /// @param[in] other The other vector to compute the cross product with.
    /// @return The cross product of this vector and the other vector.
    [[nodiscard]] constexpr Vector2<T> cross(const Vector2<T>& other) const noexcept
    {
        return *this ^ other;
    }
    ...
    /// @param[in] other The other vector to compute the dot product with.
    /// @return The dot product of this vector and the other vector.
    [[nodiscard]] constexpr T dot(const Vector2<T>& other) const noexcept
    {
        return *this | other;
    }
    ...
    [[nodiscard]] constexpr Vector2<T> getComponentMin(const Vector2<T>& other) const noexcept
    {
    ...
    [[nodiscard]] constexpr Vector2<T> getComponentMax(const Vector2<T>& other) const noexcept
    {
    ...
    [[nodiscard]] constexpr Vector2<T> getAbsolute() const noexcept
    {
    ...
    [[nodiscard]] constexpr Vector2<T> getSignVector() const noexcept
    {
    ...
    [[nodiscard]] constexpr Vector2<T> projectOnTo(const Vector2<T>& other) const noexcept
    {
    ...
    /// @return The projected vector.
    [[nodiscard]] constexpr Vector2<T> projectOnToNormal(const Vector2<T>& normal) const noexcept
    {
...
public:
    ...
    [[nodiscard]] constexpr static T cross(const Vector2<T>& lhs, const Vector2<T>& rhs) noexcept
    {
        return lhs ^ rhs;
    }
    ...
    [[nodiscard]] constexpr static T dot(const Vector2<T>& lhs, const Vector2<T>& rhs) noexcept
    {
        return lhs | rhs;
    }
    ...
    [[nodiscard]] constexpr static inline Vector2<T> min(const Vector2<T>& a, const Vector2<T>& b) noexcept
    {
    ...
    [[nodiscard]] constexpr static inline Vector2<T> max(const Vector2<T>& a, const Vector2<T>& b) noexcept
    {
...
/// @return A vector containing the minimum of each component between the three vectors.
template <concepts::IsFloatingPoint T>
[[nodiscard]] constexpr Vector2<T> min(const Vector2<T>& a, const Vector2<T>& b, const Vector2<T>& c) noexcept
{
...
/// @return A vector containing the maximum of each component between the three vectors.
template <concepts::IsFloatingPoint T>
[[nodiscard]] constexpr Vector2<T> max(const Vector2<T>& a, const Vector2<T>& b, const Vector2<T>& c) noexcept
{
...
[[nodiscard]] constexpr gp::math::Vector2<T> operator+(const U bias, const gp::math::Vector2<T>& vec) noexcept
{
    return vec + bias;
}
...
template <gp::concepts::IsFloatingPoint T, gp::concepts::IsArithmetic U>
[[nodiscard]] constexpr gp::math::Vector2<T> operator*(const U scale, const gp::math::Vector2<T>& vec) noexcept
{
    return vec * scale;
}
