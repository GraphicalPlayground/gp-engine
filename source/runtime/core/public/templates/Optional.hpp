...
inline constexpr detail::NullOptT nullopt{};
...
template <typename T>
requires concepts::IsDestructible<T> && (!concepts::IsReference<T>)class Optional
{
public:
    using ValueType = T;
...
public:
    ...
    constexpr Optional(detail::NullOptT) noexcept
        : m_hasValue(false)
    {}
    ...
    Optional& operator=(detail::NullOptT) noexcept
    {
        reset();
        return *this;
    }
