...
#define GP_ENABLE_ENUM_BITWISE_OPERATIONS(enumType) \
    template <> \
    struct ::gp::detail::EnableBitwiseOperators<enumType> : std::true_type {}
...
template <typename T>
concept IsBitwiseEnum = concepts::IsEnum<T> && detail::HasBitwiseOperatorsV<T>;
...
template <gp::concepts::IsComparableEnum E>
