...
/// @brief A 4x4 matrix template struct that can be used for various mathematical operations.
...
public:
    ...
    /// @param x33 The (3,3) component of the matrix.
    constexpr Mat4(
        T x00, T x01, T x02, T x03, T x10, T x11, T x12, T x13, T x20, T x21, T x22, T x23, T x30, T x31, T x32, T x33
    ) noexcept
        // clang-format off
