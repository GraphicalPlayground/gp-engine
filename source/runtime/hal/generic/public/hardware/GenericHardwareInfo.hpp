...
public:
    ...
    GP_NODISCARD virtual bool initialize() noexcept override;
    ...
    GP_NODISCARD virtual const CPUInfo& getCPUInfo() const noexcept override;
    ...
    GP_NODISCARD virtual const GPUInfo& getGPUInfo() const noexcept override;
    ...
    GP_NODISCARD virtual const OSInfo& getOSInfo() const noexcept override;
    ...
    GP_NODISCARD virtual std::optional<MemoryInfo> getMemoryStatus() const noexcept override;
    ...
    /// encodings.
    GP_NODISCARD virtual std::optional<DiskInfo> getDiskStatus(const char* path) const noexcept override;
    ...
    /// @todo Replace `std::optional` with a custom Result type that can provide error details on failure.
    GP_NODISCARD virtual std::optional<PowerStateInfo> getPowerState() const noexcept override;
};
