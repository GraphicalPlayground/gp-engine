...
public:
    ...
    GP_NODISCARD virtual bool initialize() noexcept = 0;
    ...
    GP_NODISCARD virtual const CPUInfo& getCPUInfo() const noexcept = 0;
    ...
    GP_NODISCARD virtual const GPUInfo& getGPUInfo() const noexcept = 0;
    ...
    GP_NODISCARD virtual std::optional<MemoryInfo> getMemoryStatus() const noexcept = 0;
    ...
    /// encodings.
    GP_NODISCARD virtual std::optional<DiskInfo> getDiskStatus(const char* path) const noexcept = 0;
