...
TEST_CASE("SHA256 Hashing", "[GP][Core][Crypto][Hash][SHA256]")
{
    ...
    SECTION("FIPS 180-4 Empty String Vector")
    {
        ...
        constexpr Byte kExpected[32] = { 0xE3, 0xB0, 0xC4, 0x42, 0x98, 0xFC, 0x1C, 0x14, 0x9A, 0xFB, 0xF4,
    ...
    SECTION("FIPS 180-4 'abc' Vector")
    {
        ...
        constexpr Byte kExpected[32] = { 0xBA, 0x78, 0x16, 0xBF, 0x8F, 0x01, 0xCF, 0xEA, 0x41, 0x41, 0x40,
    ...
    SECTION("FIPS 180-4 56-Byte Vector (Two-Block Padding Path)")
    {
        ...
        constexpr Byte kExpected[32] = { 0x24, 0x8D, 0x6A, 0x61, 0xD2, 0x06, 0x38, 0xB8, 0xE5, 0xC0, 0x26,
    ...
    SECTION("Compile-Time Evaluation")
    {
        ...
        constexpr auto d = SHA256::Hash("abc", 3);
        static_assert(d.bytes[0] == 0xBA, "SHA256 compile-time evaluation failed");
        static_assert(d.bytes[31] == 0x8A, "SHA256 compile-time evaluation failed");
        REQUIRE(d.bytes[0] == 0xBA);
        REQUIRE(d.bytes[31] == 0x8A);
    }
}
