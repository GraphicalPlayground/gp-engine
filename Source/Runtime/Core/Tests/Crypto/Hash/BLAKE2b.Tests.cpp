...
TEST_CASE("BLAKE2b Hashing", "[GP][Core][Crypto][Hash][BLAKE2b]")
{
    ...
    SECTION("BLAKE2b-512 Empty String Vector (RFC 7693)")
    {
        ...
        constexpr Byte kExpected[64] = { 0x78, 0x6A, 0x02, 0xF7, 0x42, 0x01, 0x59, 0x03, 0xC6, 0xC6, 0xFD, 0x85, 0x25,
    ...
    SECTION("BLAKE2b-256 (Default Output Length) Empty String Vector")
    {
        ...
        constexpr Byte kExpected[32] = { 0x0E, 0x57, 0x51, 0xC0, 0x26, 0xE5, 0x43, 0xB2, 0xE8, 0xAB, 0x2E,
